...
<h2>ติดต่อเรา</h2>
    ...
    <div class="row">
        <div class="col-12 col-lg-6">
            <h4>ผู้จัดทำ</h4>
            <p>ภายใต้โครงการวิจัย Hands-on ของมหาวิทยาลัยเทคโนโลยีราชมงคลล้านนา พัฒนาโดย
              <br>  &nbsp;สาขาวิชาเทคโนโลยีสารสนเทศ<br>  &nbsp;คณะวิทยาศาสตร์และเทคโนโลยีการเกษตร<br>  &nbsp;มหาวิทยาลัยเทคโนโลยีราชมงคลล้านนาตาก </p>
        </div>
        <div class="col-12 col-lg-6">
            <h4>ช่องทางการติดต่อ</h4>
            <p>สาขาวิชาเทคโนโลยีสารสนเทศ มหาวิทยาลัยเทคโนโลยีราชมงคลล้านนาตาก</p>
        </div>
    </div>
